...
class VDN_F:
    ...
    def init_hidden(self, episode_num):
        ...
        self.eval_hidden = torch.zeros((episode_num, self.n_agents, self.args.rnn_hidden_dim + self.feature_shape))
        self.target_hidden = torch.zeros((episode_num, self.n_agents, self.args.rnn_hidden_dim + self.feature_shape))
